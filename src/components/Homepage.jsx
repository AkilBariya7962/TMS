...
import tourImage from "../components/img/tourist-with-baggage-map-fuji-mountain-kawaguchiko-japan.jpg";
...
const HomePage = () => {
  return (
    <div className="overflow-hidden">
      <section
        className="relative text-white min-h-screen flex items-center justify-center px-6 sm:px-10 py-20"
        style={{
